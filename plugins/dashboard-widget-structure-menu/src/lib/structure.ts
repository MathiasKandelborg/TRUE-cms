...
// Schrödinger's thing:
// It can be there or not be there.
// If it is there, it might have properties
// Those properties can be a func
type TThing = {
  then: () => any
  subscribe: () => any
}
export function isSubscribable(thing?: TThing) {
  return (
    thing &&
...
// I went too quickly! Structure is even worse
// Who can read this and go 'Ah! That makes sense'
...
export function isStructure(structure?: TStructure) {
  return (
    structure &&
